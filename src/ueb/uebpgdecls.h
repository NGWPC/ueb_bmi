...
#else
int Write_uebaggTS_toNC_par(const char* FileName, const char* VarName, int dimOrd, int z_dim, int Nt_dim, float* var_inp);
#endif //MPI_PARALLEL
...
#else
int WriteTSto3DNC_Block(const char* FileName, const char* VarName, int dimOrd, int *YindArr, int *XindArr, int bSize, int Nt_dim, float** var_inp);
#endif //MPI_PARALLEL
#ifdef MPI_PARALLEL
...
#else
int Write3DNC(const char* FileName, const char* VarName, const char *varUnits,  const char* tName,  const char* yName, const char* xName, 
	const char* tUnits, const char* yUnits, const char* xUnits, int Nt_dim, int Ny_dim, int Nx_dim, int dimOrd, float* t_inp, float* y_inp, float* x_inp, float*** var_inp); // int &t_dimid, int &y_dimid, int &x_dimid) //time, y, x
#endif //MPI_PARALLEL
#ifdef MPI_PARALLEL
...
#else
int read3DNC(const char* FILE_NAME, const char* VAR_NAME, const char* xcor_NAME, const char* ycor_NAME, const char* tcor_NAME, float* xcorvar, float* ycorvar, float* tcorvar, float*** pvar_in);
#endif //MPI_PARALLEL
#ifdef MPI_PARALLEL
...
#else
int read3DNC_Contiguous(const char* FILE_NAME, const char* VAR_NAME, const char* tcor_NAME, const char* ycor_NAME, const char* xcor_NAME,
	float* tcorvar, float* ycorvar, float* xcorvar, size_t &Ntdim, size_t &Nydim, size_t &Nxdim, float*** &pvar_in);
#endif //MPI_PARALLEL
...
#else
int readNC_TS_Block(const char* FILE_NAME, const char* VAR_NAME, const char* tcor_NAME, const char* ycor_NAME, const char* xcor_NAME,
	float** &pvar_in, int &nrecords, int *YindArr, int *XindArr, int bSize); // /*float* &tcorvar, int ydim, int xdim, */ int tIndx) 
#endif //MPI_PARALLEL
